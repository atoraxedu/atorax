...
const heroData = [
   {
      ...
      card2Label: "Format", card2Value: "16-Weeks Sprint", card2Icon: <Clock size={20} />,
   ...
   },
   {
      ...
      card2Label: "Format", card2Value: "16-Weeks Cohort", card2Icon: <Clock size={20} />,
                  ...
                  <div className="flex flex-wrap gap-2 mt-8 md:mt-0 p-1.5 glass-panel rounded-2xl">
                     {["All", "Engineering", "AI & Data", "Business & Growth"].map(c => (
                        <button
                           key={c}
                           onClick={() => setFilter(c)}
                           className={`px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-300 ${filter === c
