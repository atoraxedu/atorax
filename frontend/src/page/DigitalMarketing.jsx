            ...
            <div className="flex flex-col gap-4">
              {careerPaths.map((path, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className={`border rounded-2xl overflow-hidden transition-all duration-300 cursor-pointer ${isActive ? "border-amber-600/50 bg-amber-950/40" : "border-amber-900/30 bg-[#1a0a00] hover:border-amber-700/50"
                      }`}
      ...
      <section className="py-24 px-6 bg-[#020408] border-t border-white/5 relative overflow-hidden flex flex-col items-center text-center">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center">
          ...
          <h2 className="text-3xl md:text-[48px] leading-[1.2] font-black text-white tracking-tight mb-6 ag-font-outfit max-w-4xl mx-auto">
            ...
            <span className="text-[#f59e0b]">It Will Come From Becoming Impossible to Ignore.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 w-full sm:w-auto">
            <div onClick={() => setShowPopup(true)} className="w-full sm:w-auto cursor-pointer">
              <div className="px-8 py-4 text-[16px] rounded-xl bg-[#f59e0b] hover:bg-[#d97706] text-white font-bold flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(245,158,11,0.3)] w-full">
