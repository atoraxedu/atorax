        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 w-full sm:w-auto">
            <div onClick={() => setShowPopup(true)} className="w-full sm:w-auto cursor-pointer">
              <div className="px-8 py-4 text-[16px] rounded-xl bg-[#0ea5e9] hover:bg-[#0284c7] text-white font-bold flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(14,165,233,0.3)] w-full">
